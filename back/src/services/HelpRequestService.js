...
/**
 * create helpRequest
 * @param entity the helpRequest entity
 */
function* create(entity) {
  entity.status = models.Const.RequestStatus.new;
  return yield models.HelpRequest.create(entity);
}
...
function* getAll(filter) {
  ...
  const docs = yield models.HelpRequest.findAndCountAll(query);
  return {
    items: docs.rows,
